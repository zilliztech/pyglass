...
#include "glass/searcher/sparse_graph_searcher.hpp"
#include "glass/searcher/sparse_searcher.hpp"
...
struct SparseGraphSearcher {
  ...
  py::object batch_search(int32_t nq, py::object indptr, py::object indices,
    ...
    searcher.SearchBatch(nq, (int64_t *)indptr_x.data(0),
...
#define PYDECLARE_QUANT(py_name)                                               \
  ...
  py::class_<SparseGraphSearcher>(m, "SparseGrapSearcher")
      .def(py::init<const std::string &, const std::string &, int32_t,
                    int32_t>(),
           py::arg("filename"), py::arg("graphfile"), py::arg("R"),
           py::arg("L"))
