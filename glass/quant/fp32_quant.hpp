...
#pragma omp parallel for schedule(dynamic)
    ...
    constexpr static auto dist_func = metric == Metric::L2 ? helpa::l2_fp32_fp32 : helpa::dot_fp32_fp32;

    constexpr static auto dist_func_sym = dist_func;

    using ComputerType = ComputerImpl<Tensor, dist_func, float, float, float, float>;
